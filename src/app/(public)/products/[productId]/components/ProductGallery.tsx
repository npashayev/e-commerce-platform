...
const ProductGallery = ({ product }: Props) => {
  ...
  return (
    <div className={styles.productGallery}>
      <div className={styles.availability} style={{ color: 'white', backgroundColor: productStockInfo.color }}>
      ...
      <div className={styles.galleryFooter}>
        <button className={styles.arrowButton} onClick={() => scrollThumbnails('left')}>
        ...
        <button className={styles.arrowButton} onClick={() => scrollThumbnails('right')}>
